...
const steps = [
  ...
  // ========================================
  // autocomplete の例: suggestions で入力候補を表示
  // ========================================
  {
    slug: 'libraries',
    title: 'ライブラリ',
  ...
  // ========================================
  // 多重 repeatable の例: repeatable > group > repeatable
  // モジュール内に複数の機能を持つネスト構造
  // ========================================
  {
    slug: 'modules',
    title: 'モジュール',
    ...
    fields: [
      {
        ...
        field: {
          ...
          fields: [
            ...
            // 多重 repeatable: 各モジュール内に複数の機能を追加可能
            {
              type: 'repeatable',
              id: 'features',
              label: '機能一覧',
