...
const steps = [
  ...
  // ========================================
  // Autocomplete example: suggestions for input completion
  // ========================================
  {
    slug: 'libraries',
    title: 'Libraries',
          ...
          fields: [
            {
              ...
              required: true,
              // autocomplete: press Tab to select suggestions
              suggestions: [
                'react-query',
                'zod',
                'zustand',
  ...
  // ========================================
  // Nested repeatable example: repeatable > group > repeatable
    ...
    fields: [
      {
        ...
        field: {
          ...
          fields: [
            ...
            // Nested repeatable: each module can have multiple features
            {
              type: 'repeatable',
              id: 'features',
              label: 'Features',
